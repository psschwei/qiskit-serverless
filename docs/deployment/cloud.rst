...
.. code-block::
   :caption: run this commands with the release version like 0.9.4 in x.y.z (2 places)
...
.. code-block::
   :caption: run this commands with the release version like 0.9.4 in x.y.z (2 places) using the same namespace as in the previous helm command
